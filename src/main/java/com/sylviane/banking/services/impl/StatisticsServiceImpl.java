...
public class StatisticsServiceImpl implements StatisticsService {
    ...
    public BigDecimal highestTransfert(Integer userId) {
        return transactionRepository.findHighestAccountByTransactionType(userId, TransactionType.TRANSFERT);
    }

    @Override
    public BigDecimal highestDeposit(Integer userId) {
        return transactionRepository.findHighestAccountByTransactionType(userId, TransactionType.DEPOSIT);
    }
}
